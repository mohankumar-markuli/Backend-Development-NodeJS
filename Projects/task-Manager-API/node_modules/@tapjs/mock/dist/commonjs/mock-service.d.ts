...
export declare class MockService {
    ...
    static listen(port: MessagePort): void;
    static handle(msg: any): string | undefined;
    static resolve(req: Omit<MockServiceResolveRequest, 'id'>): string | undefined;
    resolve({ url, parentURL }: Omit<MockServiceResolveRequest, 'id'>): string | undefined;
    static load(req: Omit<MockServiceLoadRequest, 'id'>): string | undefined;
    load({ url }: Omit<MockServiceLoadRequest, 'id'>): string | undefined;
