 ...
 */
export declare const resolveAllLocalImports: (packageJsonPath: string | URL, options?: ResolveImportOpts) => Promise<Record<string, string | URL>>;
//# sourceMappingURL=resolve-all-local-imports.d.ts.map