 ...
 * reason.
 */
export declare const resolveImportSync: (url: string | URL, parentURL?: string | URL | undefined, options?: ResolveImportOpts) => string | URL;
//# sourceMappingURL=resolve-import-sync.d.ts.map