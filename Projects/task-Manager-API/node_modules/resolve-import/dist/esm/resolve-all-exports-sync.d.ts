 ...
 */
export declare const resolveAllExportsSync: (packageJsonPath: string | URL, options?: ResolveImportOpts) => Record<string, string | URL>;
//# sourceMappingURL=resolve-all-exports-sync.d.ts.map