...
parentURL = undefined, options = {}) => {
    ...
    const pu = parentURL ? toFileURL(realpathParentDir(parentURL)) : undefined;
    ...
    const parentPath = toPath(parentURL || resolve(realpathSync(process.cwd()), 'x'));
    const opts = {
        ...options,
...
//# sourceMappingURL=resolve-import-sync.js.map