...
exports.resolveAllExportsSync = void 0;
/**
 ...
 */
const resolveAllExportsSync = (packageJsonPath, options = {}) => {
    const pjPath = (0, to_path_js_1.toPath)(packageJsonPath);
    const pjDir = (0, path_1.dirname)(pjPath);
    const pkg = (0, read_pkg_js_1.readPkgSync)(pjPath);
    if (!pkg) {
        throw (0, errors_js_1.invalidPackage)(packageJsonPath, exports.resolveAllExportsSync);
    }
    const results = {};
    const { exports } = pkg;
    for (const sub of (0, get_named_exports_list_js_1.getNamedExportsList)(exports)) {
        ...
        if (sres.length === 2 && ssub.length === 2) {
            for (const [rep, target] of (0, star_glob_js_1.starGlobSync)(sres, pjDir)) {
...
exports.resolveAllExportsSync = resolveAllExportsSync;
//# sourceMappingURL=resolve-all-exports-sync.js.map